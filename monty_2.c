...
/**
 * f_pint - prints the top for the stack
...
/**
 * f_pchar - prints out a char
 * @stack: pointered to a stack
 * @n: line number that opcode is call at.
 */
void f_pchar(stack_t **stack, unsigned int n)
{
	if (!stack || !(*stack))
	{
 ...
 * @n: line number that opcode is call at.
 */
void f_pstr(stack_t **stack, unsigned int n)
{
	stack_t *node;
	(void) n;
 ...
 * Return: nothing
 */
void f_rotl(stack_t **stack, unsigned int n)
{
...
/**
 * f_rotr - rotate a linked list to the right
 * @stack: ptr to top of stack
 * @n: line number
 */
void f_rotr(stack_t **stack, unsigned int n)
{
	stack_t *h = NULL, *t = NULL;
